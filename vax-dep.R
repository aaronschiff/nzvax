# Vaccination rates vs deprivation index by TLA area
...
dat_vax <- read_csv(file = here(glue("data/vaccination_tla_{latest_date}.csv"))) |> 
  clean_names() |> 
...
# *****************************************************************************
# Compare deprivation and vaccination ----
...
dat_dep_vax_tla <- 
  ...
  left_join(y = dat_vax, by = c("ta_2018_name" = "tla")) |> 
